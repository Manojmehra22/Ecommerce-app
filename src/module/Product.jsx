          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                <button className="border-2 border-gray-300 ml-1 bg-gray-700 srounded-full w-6 h-6 focus:outline-none"></button>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex">
                <button className="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded mr-2">
                  Buy it Now
                </button>
                <button className="flex ml-auto   border  border-[#F59E0B] py-2 px-6 focus:outline-none hover:bg-yellow-600 hover:text-white rounded">
                  Add to Cart
                </button>
              </div>
